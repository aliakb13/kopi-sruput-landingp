...
const Contact = () => {
  return (
    ...
    >
      ...
      >
        <div>
          <h2 className="text-2xl text-center md:text-start font-bold text-yellow-500">
        ...
        <div className="items-center">
          <a
            href="https://wa.me/6287894517901"
            target="_blank"
            className="flex flex-col items-center md:flex-row gap-3"
          >
            <svg
              viewBox="0 0 24 24"
              width="23"
