...
const Footer = () => {
  return (
    <footer
      className="footer footer-center bg-cover bg-center text-white rounded p-10 relative"
    ...
    >
      ...
      <p className="text-center relative mt-8">
        Copyright © 2024 - All rights reserved by Kedai Seruput
      </p>
    </footer>
  );
};
